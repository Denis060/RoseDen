...
import { ArrowLeft, MapPin, Pencil, Phone, Ruler } from "lucide-react";
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await updateCustomer(customer!.id, {
        name: String(form.get("name")), phone: String(form.get("phone")), address: String(form.get("address")), notes: String(form.get("notes")),

...
export default function AdminExpensesPage() {
  ...
  function submit(event: FormEvent<HTMLFormElement>) {
    ...
    addExpense({ date: String(f.get("date")), category: String(f.get("category")), amount: Number(f.get("amount")), notes: String(f.get("notes")), batchId: String(f.get("batchId")) || undefined });
    modal.hide();
  }

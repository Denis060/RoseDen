  ...
  return (
    <div>
      ...
      <div className="mb-7 grid gap-3 sm:grid-cols-2">
        <Link href="/orders?status=1" className="flex min-h-14 items-center justify-center gap-2 rounded-2xl bg-burgundy px-5 font-semibold text-white shadow-soft"><Megaphone size={20} /> Record status/social order</Link>
        <Link href="/orders?new=1" className="flex min-h-14 items-center justify-center gap-2 rounded-2xl border border-burgundy/20 bg-white px-5 font-semibold text-burgundy"><Plus size={20} /> Regular sale or order</Link>
      </div>
      ...
      <Link href="/batches" className="mt-7 flex items-center justify-between rounded-2xl bg-wine p-4 text-white"><div><p className="text-xs text-gold">Buying → posting → selling</p><p className="mt-1 font-display text-lg font-semibold">Track post batches and trip profit</p></div><ArrowRight /></Link>
      <section className="mt-7">
        <div className="mb-3 flex items-center justify-between"><h2 className="font-display text-xl font-semibold text-wine">Low stock</h2><Link href="/inventory" className="text-xs font-semibold text-burgundy">View inventory</Link></div>
      ...
      <section className="mt-7">
        <div className="mb-3 flex items-center justify-between"><h2 className="font-display text-xl font-semibold text-wine">Recent transactions</h2><Link href="/reports" className="text-xs font-semibold text-burgundy">See reports</Link></div>
